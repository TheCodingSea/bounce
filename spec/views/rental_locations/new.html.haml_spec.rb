...
RSpec.describe "rental_locations/new", type: :view do
  before(:each) do
    assign(:rental_location, RentalLocation.new(
      :first_name => "MyString",
      :last_name => "MyString",
      :address_1 => "MyString",
      :address_2 => "MyString",
  ...
  it "renders new rental_location form" do
    render

    assert_select "form[action=?][method=?]", rental_locations_path, "post" do
